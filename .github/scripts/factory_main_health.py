#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.factory_main_health`."""
...
from latticery.factory_main_health import *  # noqa: F401,F403

try:
    from latticery.factory_main_health import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.factory_main_health has no CLI entry point")

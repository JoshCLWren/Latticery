#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.factory_post_merge_closure`."""
...
from latticery.factory_post_merge_closure import *  # noqa: F401,F403

try:
    from latticery.factory_post_merge_closure import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.factory_post_merge_closure has no CLI entry point")

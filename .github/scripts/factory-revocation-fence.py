#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.factory_revocation_fence`."""
...
from latticery.factory_revocation_fence import *  # noqa: F401,F403

try:
    from latticery.factory_revocation_fence import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.factory_revocation_fence has no CLI entry point")

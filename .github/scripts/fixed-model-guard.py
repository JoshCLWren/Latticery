#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.fixed_model_guard`."""
...
from latticery.fixed_model_guard import *  # noqa: F401,F403

try:
    from latticery.fixed_model_guard import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.fixed_model_guard has no CLI entry point")

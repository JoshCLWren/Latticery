#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.classify_fixed_model_run`."""
...
from latticery.classify_fixed_model_run import *  # noqa: F401,F403

try:
    from latticery.classify_fixed_model_run import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.classify_fixed_model_run has no CLI entry point")

#!/usr/bin/env python3
"""Compatibility entry point for :mod:`latticery.stale_pr_decay`."""
...
from latticery.stale_pr_decay import *  # noqa: F401,F403

try:
    from latticery.stale_pr_decay import main as _main
except ImportError:
    _main = None

if __name__ == "__main__":
    if _main is None:
        raise SystemExit("latticery.stale_pr_decay has no CLI entry point")

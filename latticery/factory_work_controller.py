#!/usr/bin/env python3
"""Deterministic GitHub assignment and lease reconciliation for a host repository."""
...
def active_fixed_workers() -> ActiveWorkerResult:
    ...
    if numeric_unresolved:
        try:
            pages = gh_json(['api', '--paginate', '--slurp', f'repos/{REPO}/issues/{factory_registry_issue()}/comments?per_page=100'])
        except RuntimeError:
